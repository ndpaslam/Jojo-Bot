...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'ᴊᴏᴊᴏ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `ᴊᴏᴊᴏ ʙʏ ᴋᴏᴍᴛᴏʟ ${global.version}`,
}
  try {
      ...
      video: fs.readFileSync('./menuvid/elaina.mp4'),
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ᴍ ᴇ ɴ ᴜ   ʙ ᴏ ᴛ   ᴊ ᴏ ᴊ ᴏ',
                    thumbnailUrl: 'https://telegra.ph/file/95efee308b6504f67d548.jpg',
                    sourceUrl: 'https://github.com/kaixzzoo',
                    mediaType: 1,
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴊᴏᴊᴏ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaKe85oFSAtA7Qj0d938', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
